      ...
      <form onSubmit={submit} className="mt-6 space-y-3">
        <label className="block">
          ...
          <select
            ...
            className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-base focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
          >
            {players.map((p) => (
        ...
        <label className="block">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-base focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
          />
        </label>
